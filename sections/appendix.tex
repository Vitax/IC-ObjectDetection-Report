\begin{document}
\large{Tensorflow .config} \label{tfconfig}
...
train_config: {
  ...
  fine_tune_checkpoint: "/code/image_retrieval/tensorflow/models/research/object_detection/trained_models/faster_rcnn_inception_v2/model.ckpt"
